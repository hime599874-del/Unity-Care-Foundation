...
export const translations: Translations = {
  ...
  birth_year: { bn: 'জন্ম সাল (৪ সংখ্যা)', en: 'Birth Year (4 digits)' },
  ...
  reg_error_birth_year: { bn: 'সঠিক জন্ম সাল প্রদান করুন (যেমন: ১৯৯৫)।', en: 'Please provide a valid birth year (e.g., 1995).' },
