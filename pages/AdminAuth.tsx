...
const AdminAuth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F1F5F9] flex items-center justify-center p-4">
      <div className="w-full max-w-xs bg-white p-8 rounded-3xl shadow-2xl shadow-slate-200 border border-slate-100 text-center">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="relative">
            <input
              ...
              autoFocus
              placeholder="••••"
              className="w-full text-center tracking-[0.5em] text-3xl font-bold bg-slate-50 border border-slate-200 rounded-2xl p-4 text-teal-600 outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all placeholder:text-slate-200"
              value={pin}
        ...
        <button 
          onClick={() => navigate('/')}
          className="mt-8 flex items-center justify-center gap-2 text-slate-400 hover:text-teal-600 transition-colors text-[10px] font-bold uppercase tracking-widest w-full"
        >
