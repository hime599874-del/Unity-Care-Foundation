  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-xl font-black text-slate-800 mb-2">ইউজার পাওয়া যায়নি</h2>
        <p className="text-slate-500 mb-6">দুঃখিত, এই কিউআর কোডটি সঠিক নয় অথবা ইউজারটি মুছে ফেলা হয়েছে।</p>
        <button 
          onClick={() => navigate('/')}
          className="px-6 py-3 bg-teal-600 text-white rounded-2xl font-black uppercase tracking-widest shadow-lg shadow-teal-200"
        >
          হোমে ফিরে যান
        </button>
      </div>
    ...
    <div className="min-h-screen bg-slate-50 pb-12">
      ...
      <div className="bg-teal-600 pt-12 pb-24 px-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="w-32 h-32 bg-white rounded-[2.5rem] p-1 shadow-2xl mb-4 relative group">
            {user.profilePic ? (
              <img 
                src={user.profilePic} 
                alt={user.name} 
              ...
              <div className="w-full h-full bg-slate-100 rounded-[2.3rem] flex items-center justify-center">
      ...
      <div className="px-6 -mt-12 relative z-20">
        <div className="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 p-6 mb-6 border border-slate-100">
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-slate-50 p-4 rounded-3xl border border-slate-100">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">মোট দান</p>
              <p className="text-lg font-black text-teal-600 italic">৳{toBengaliNumber(user.totalDonation)}</p>
            </div>
            <div className="bg-slate-50 p-4 rounded-3xl border border-slate-100">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">লেনদেন সংখ্যা</p>
              <p className="text-lg font-black text-indigo-600 italic">{toBengaliNumber(user.transactionCount)} বার</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">মোবাইল নাম্বার</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">ইমেইল আইডি</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">রক্তের গ্রুপ</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">বয়স</p>
            ...
            <div className="grid grid-cols-2 gap-6 pt-4 border-t border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">যোগদানের তারিখ</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">মেয়াদ শেষ</p>
          ...
          <div className="space-y-3">
            {transactions.length > 0 ? (
              transactions.slice(0, 10).map((tx) => (
                <div key={tx.id} className="bg-white p-4 rounded-[1.8rem] shadow-sm border border-slate-100 flex justify-between items-center">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="text-right">
                    <p className="font-black text-slate-900 text-sm italic">৳{toBengaliNumber(tx.amount)}</p>
                  </div>
                </div>
              ))
            ) : (
              <div className="bg-white p-8 rounded-[2rem] text-center border border-dashed border-slate-200">
                <p className="text-slate-400 text-[10px] font-black uppercase tracking-widest">কোন লেনদেনের রেকর্ড নেই</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-200/50 rounded-full">
            ...
            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Verified by Unity Care</span>
          </div>
        </div>
      </div>
    </div>
