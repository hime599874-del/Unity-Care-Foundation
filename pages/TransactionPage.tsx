    ...
    <div className="bg-transparent dark:bg-slate-950 min-h-screen pb-20 font-['Hind_Siliguri'] transition-colors duration-300">
      ...
      <div className="p-4 max-w-lg mx-auto space-y-4">
        <form onSubmit={handleSubmit} className="space-y-4">
             ...
             <div className="grid grid-cols-3 gap-2">
                {quickAmounts.map(amt => (
                  <button 
                    ...
                    className="p-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-[10px] font-black text-slate-600 dark:text-slate-400 active:scale-95 transition-all hover:bg-white dark:hover:bg-slate-700 hover:border-teal-200 shadow-sm"
                  >
                    ৳{toBengaliNumber(amt)}
                  </button>
                ))}
          ...
          <div className="bg-white dark:bg-slate-900 p-4 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 space-y-2">
          ...
          <button type="submit" disabled={isSubmitting} className="w-full py-4 bg-teal-600 text-white rounded-3xl font-black text-lg shadow-xl active:scale-95 transition-all border-b-[6px] border-teal-800">
